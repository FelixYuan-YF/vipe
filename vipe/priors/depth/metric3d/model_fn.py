...
MODEL_TYPE = {
    "ConvNeXt-Tiny": {
        ...
        "ckpt_file": "https://hf-mirror.com/JUGGHM/Metric3D/resolve/main/convtiny_hourglass_v1.pth",
    },
    "ConvNeXt-Large": {
        "cfg_file": f"{metric3d_dir}/model/configs/convlarge.0.3_150.py",
        "ckpt_file": "https://hf-mirror.com/JUGGHM/Metric3D/resolve/main/convlarge_hourglass_0.3_150_step750k_v1.1.pth",
    },
    "ViT-Small": {
        "cfg_file": f"{metric3d_dir}/model/configs/vit.raft5.small.py",
        "ckpt_file": "https://hf-mirror.com/JUGGHM/Metric3D/resolve/main/metric_depth_vit_small_800k.pth",
    },
    "ViT-Large": {
        "cfg_file": f"{metric3d_dir}/model/configs/vit.raft5.large.py",
        "ckpt_file": "https://hf-mirror.com/JUGGHM/Metric3D/resolve/main/metric_depth_vit_large_800k.pth",
    },
    "ViT-giant2": {
...
MODEL_DIR = "checkpoints/metric3d"
...
def metric3d_convnext_tiny(pretrain=False, **kwargs):
    ...
    if pretrain:
        model.load_state_dict(
            torch.hub.load_state_dict_from_url(ckpt_file, model_dir=MODEL_DIR)["model_state_dict"],
            strict=False,
        )
    return model
